    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < SERIES.length() - SUBSERIES_LENGTH + 1; i++) {
            ...
            if (!subseries.toString().contains("0")) {
                ...
                for (char c : subseries.toString().toCharArray()) {
                    subseriesProduct *= Long.parseLong(Character.toString(c));
                }

                if (subseriesProduct > highestFoundProduct) {
                    highestFoundProduct = subseriesProduct;
        ...
        System.out.println("\nNumber of subseries tested: " + finalNumOfCalculations);
        System.out.println(subseriesWithHighestProduct + " is the subseries with the highest product of " + highestFoundProduct);
    }
}
