...
public class _11_LargestProductInAGrid {
    ...
    private static int greatestForwardDiagonal() {
        ...
        for (int x = 0; x < GRID.get(0).size(); x++) {
            for (int y = 0; y < GRID.size() - 1; y++) {
                if (x + 3 <= GRID.get(0).size() - 1 && y + 3 <= GRID.size() - 1) {
                    int one = Integer.parseInt(GRID.get(x).get(y + 3));
                    int two = Integer.parseInt(GRID.get(x + 1).get(y + 2));
                    int three = Integer.parseInt(GRID.get(x + 2).get(y + 1));
                    int four = Integer.parseInt(GRID.get(x + 3).get(y));
    ...
    private static int greatestBackwardDiagonal() {
        ...
        for (int x = 0; x < GRID.get(0).size(); x++) {
            for (int y = 0; y < GRID.size() - 1; y++) {
                if (x + 3 <= GRID.get(0).size() - 1 && y + 3 <= GRID.size() - 1) {
                    int one = Integer.parseInt(GRID.get(x).get(y));
                    int two = Integer.parseInt(GRID.get(x + 1).get(y + 1));
                    int three = Integer.parseInt(GRID.get(x + 2).get(y + 2));
                    int four = Integer.parseInt(GRID.get(x + 3).get(y + 3));
    ...
    private static int greatestHorizontal() {
        ...
        for (ArrayList<String> row : GRID) {
            for (int x = 0; x < row.size(); x++) {
                if (x + 3 <= row.size() - 1) {
                    int one = Integer.parseInt(row.get(x));
                    int two = Integer.parseInt(row.get(x + 1));
                    int three = Integer.parseInt(row.get(x + 2));
                    int four = Integer.parseInt(row.get(x + 3));
    ...
    private static int greatestVertical() {
        ...
        for (int x = 0; x < GRID.get(0).size(); x++) {
            for (int y = 0; y < GRID.size() - 1; y++) {
                if (y + 3 <= GRID.size() - 1) {
                    int one = Integer.parseInt(GRID.get(y).get(x));
                    int two = Integer.parseInt(GRID.get(y + 1).get(x));
                    int three = Integer.parseInt(GRID.get(y + 2).get(x));
                    int four = Integer.parseInt(GRID.get(y + 3).get(x));
